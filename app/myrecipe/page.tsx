...
export default function MyRecipePage() {
  return (
    <div style={{ backgroundColor: '#FFFDF9', fontFamily: 'Georgia, serif', color: '#2C1810', overflowX: 'hidden' }}>
      ...
      {/* HERO */}
      <section style={{ background: 'linear-gradient(170deg, #F5EDE0 0%, #FDF6EE 50%, #FFFDF9 100%)', padding: '72px 32px 56px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 64, flexWrap: 'wrap' }}>
        {/* Left — copy */}
        <div style={{ maxWidth: 480, flex: '1 1 320px' }}>
          ...
          <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(38px, 5vw, 60px)', fontWeight: 700, lineHeight: 1.08, color: '#2C1810', marginBottom: 8 }}>
            Your AI Kitchen,
          </h1>
          <h1 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(38px, 5vw, 60px)', fontWeight: 700, lineHeight: 1.08, color: '#C8401A', marginBottom: 24 }}>
            All In One Place.
          </h1>
          <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 17, lineHeight: 1.7, color: '#5C4A3A', marginBottom: 36, maxWidth: 400 }}>
            Save recipes. Learn to cook. Plan meals. Shop smarter. Share your creations. All powered by Chef Jen, your AI sous chef.
          </p>
          {/* CTA buttons */}
          ...
          {/* Free callout */}
          <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 12, color: '#78716C', marginTop: 16 }}>✓ Free to start &nbsp;·&nbsp; ✓ No credit card needed &nbsp;·&nbsp; ✓ iPhone</p>
        </div>

        {/* Right — hero phone image */}
        <div style={{ flex: '0 0 auto', display: 'flex', justifyContent: 'center' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/0001-hub-iphone.png" alt="MyRecipe Companion App" style={{ width: 'clamp(260px, 30vw, 360px)', borderRadius: 32, boxShadow: '0 40px 100px rgba(44,24,16,0.18)', display: 'block' }} />
        </div>
      </section>
      ...
      <section style={{ backgroundColor: '#FFFDF9', padding: '72px 32px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 64, flexWrap: 'wrap', justifyContent: 'center' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/0002-vault-iphone.png" alt="Recipe Vault" style={{ width: 'clamp(220px, 25vw, 300px)', borderRadius: 28, boxShadow: '0 24px 64px rgba(44,24,16,0.14)', flexShrink: 0 }} />
          <div style={{ maxWidth: 440 }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 700, lineHeight: 1.15, marginBottom: 16, color: '#2C1810' }}>Your Recipe Collection Engine.</h2>
            <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 16, lineHeight: 1.75, color: '#5C4A3A', marginBottom: 24 }}>Import recipes from any website, paste text, or share from Safari. Every recipe beautifully organised in one place — searchable, sortable, always with you.</p>
      ...
      <section style={{ backgroundColor: '#F5EDE0', padding: '72px 32px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 64, flexWrap: 'wrap-reverse', justifyContent: 'center' }}>
          <div style={{ maxWidth: 440 }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 700, lineHeight: 1.15, marginBottom: 16, color: '#2C1810' }}>Where Recipes Become Memories.</h2>
          ...
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/0004-box-iphone.png" alt="Recipe Box" style={{ width: 'clamp(220px, 25vw, 300px)', borderRadius: 28, boxShadow: '0 24px 64px rgba(44,24,16,0.14)', flexShrink: 0 }} />
        </div>
      </section>
      ...
      <section id="school" style={{ background: 'linear-gradient(135deg, #2C1810 0%, #4A2518 100%)', padding: '72px 32px' }}>
        <div style={{ maxWidth: 1000, margin: '0 auto', display: 'flex', alignItems: 'center', gap: 64, flexWrap: 'wrap', justifyContent: 'center' }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/0005-school-iphone.png" alt="AI Cooking School" style={{ width: 'clamp(220px, 25vw, 300px)', borderRadius: 28, boxShadow: '0 24px 64px rgba(0,0,0,0.3)', flexShrink: 0 }} />
          <div style={{ maxWidth: 440 }}>
            ...
            <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(28px, 4vw, 42px)', fontWeight: 700, lineHeight: 1.15, marginBottom: 16, color: '#FFFDF9' }}>Learn. Practice. Master.</h2>
      ...
      {/* SCREENSHOT GALLERY */}
      <section id="gallery" style={{ backgroundColor: '#F5EDE0', padding: '72px 0' }}>
        <div style={{ maxWidth: 960, margin: '0 auto', paddingLeft: 32, paddingRight: 32 }}>
          ...
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 'clamp(26px, 4vw, 38px)', fontWeight: 700, textAlign: 'center', marginBottom: 40, color: '#2C1810' }}>Built for how you really cook.</h2>
        </div>
        <div style={{ display: 'flex', gap: 20, overflowX: 'auto', paddingLeft: 32, paddingRight: 32, paddingBottom: 16, scrollbarWidth: 'none' }}>
          {SCREENSHOTS.map((s) => (
            <div key={s.file} style={{ flexShrink: 0, textAlign: 'center' }}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={`/${s.file}`} alt={s.label} style={{ width: 180, borderRadius: 20, boxShadow: '0 16px 48px rgba(44,24,16,0.14)', display: 'block' }} />
              <p style={{ fontFamily: 'system-ui, sans-serif', fontSize: 12, color: '#78716C', marginTop: 10, fontWeight: 600 }}>{s.label}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: 24, alignItems: 'center' }}>
            ...
            <div style={{ backgroundColor: '#F5EDE0', borderRadius: 20, padding: '32px 28px', border: '1px solid #E8D8C4' }}>
              ...
              <div style={{ marginBottom: 6 }}>
                <span style={{ fontFamily: 'Georgia, serif', fontSize: 40, fontWeight: 700, color: '#2C1810' }}>$0</span>
                <span style={{ fontFamily: 'system-ui, sans-serif', fontSize: 14, color: '#78716C' }}> / forever</span>
              </div>
            ...
            {/* PREMIUM */}
            <div style={{ backgroundColor: '#2C1810', borderRadius: 24, padding: '36px 28px', boxShadow: '0 24px 72px rgba(44,24,16,0.28)', transform: 'scale(1.04)', position: 'relative' }}>
              <h3 style={{ fontFamily: 'Georgia, serif', fontSize: 24, fontWeight: 700, color: '#FFFDF9', marginBottom: 4 }}>Premium</h3>
              <div style={{ marginBottom: 4 }}>
                <span style={{ fontFamily: 'Georgia, serif', fontSize: 40, fontWeight: 700, color: '#FFFDF9' }}>$34.99</span>
                <span style={{ fontFamily: 'system-ui, sans-serif', fontSize: 14, color: '#D4A574' }}> / year</span>
              </div>
            ...
            <div style={{ backgroundColor: '#F5EDE0', borderRadius: 20, padding: '32px 28px', border: '2px solid #C8401A', position: 'relative' }}>
              ...
              <div style={{ marginBottom: 4 }}>
                <span style={{ fontFamily: 'Georgia, serif', fontSize: 40, fontWeight: 700, color: '#2C1810' }}>$49.99</span>
                <span style={{ fontFamily: 'system-ui, sans-serif', fontSize: 14, color: '#78716C' }}> / year</span>
              </div>
